...
def crimeweather_state(city):
    ...
    CrimeWeather.latitude,CrimeWeather.longitude,CrimeWeather.mapping,CrimeWeather.weather).filter(CrimeWeather.city == city).all() #.first()
...
#     results = db.session.query(sunburst.city, sunburst.mapping, sunburst.weather).all()
